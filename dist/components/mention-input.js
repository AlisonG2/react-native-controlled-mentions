...
const MentionInput = (_a) => {
    ...
    return (react_1.default.createElement(react_native_1.View, { style: containerStyle },
        ...
        react_1.default.createElement(react_native_gesture_handler_1.TextInput, Object.assign({ multiline: true }, textInputProps, { ref: handleTextInputRef, onChangeText: onChangeInput, onSelectionChange: handleSelectionChange }),
